...
<body class="font-sans bg-black-100 text-white">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <div class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#FF2D20] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        <svg width="60px" height="60px" viewBox="0 0 48 48" version="1" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 48 48" fill="#000000">
                    ...
                    @if (Route::has('login'))
                    <div class="flex m-15 lg:justify-center lg:col-start-2">
                        @auth
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    Todo List App <br /> By Wahtu Astrawan
                </footer>
            </div>
        </div>
    </div>
